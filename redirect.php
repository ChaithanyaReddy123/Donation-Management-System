  ...
  <body>
    <div class="container">
      ...
      <div class="page-header">
        ...
        <p class="lead" style=color:blue>Thank you for your donation to 4-THE-CHILDREN.</p>
      </div>

      <strong><h3 style="color:#6da552">Payment Done Sucessfully!!</h3> </strong>
   
    <p> Thank you for supporting Charity work with your generous regular donations. Your valuable gift is helping us provide long-term support to CHILDREN IN NEED.
</p>
